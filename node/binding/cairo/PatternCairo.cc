...
#include "PatternCario.h"

#include "CanvasCario.h"
#include "ImageCario.h"
...
PatternCario::PatternCario()
{

}


static Napi::Object PatternCario::NewInstance(Napi::Env env, cairo_surface_t *surface, repeat_type_t repeat );
{
    Napi::Object obj = constructor.New({arg});
    obj.Set("name", Napi::String::New(env, "patterncario"));
    return obj;
}

void PatternCario::Init(Napi::Env env) 
{
  Napi::HandleScope scope(env);
  Napi::Function func  = DefineClass(env, "PatternCario", { });
